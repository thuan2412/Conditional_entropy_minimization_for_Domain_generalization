...
if __name__ == "__main__":
    ...
    parser.add_argument('--holdout_fraction', "--hf", type=float, default=0.05)  ## percentage of validation set
    ...
    parser.add_argument('--env_seed', type=int, default=1, help="decide the correlation relation between color & digit") # 0 is oracle model
    parser.add_argument('--no_aug', action='store_true')
    parser.add_argument('--xyl', default=1, type=int)

    parser.add_argument("--n_restarts", "--nr", default=5, type=int)
    parser.add_argument("--test_val", default= 0) # two options 0 or 1 corresponding to train-validation or test-validation tuning procedure
    ...
    for ib_lambda in [0.1, 1, 10, 100, 1000, 10000]:  
        ...
        for irm_lambda in [0.1, 1, 10, 100, 1000, 10000]:
